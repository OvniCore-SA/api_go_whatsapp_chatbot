...
type ConfigurationsService struct {
	repository *postgres_client.ConfigurationsRepository
}

func NewConfigurationsService(repository *postgres_client.ConfigurationsRepository) *ConfigurationsService {
